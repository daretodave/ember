...
- source signals:
  ...
  - iterate pattern: 12 scope items remain unresolved across the voice coherence candidate; all pending AUDIT.md findings score ≤ 2.7, consistently below the 3.0 iterate threshold; the cluster now spans 9 consecutive critique passes (7–15); signals updated pass 26
